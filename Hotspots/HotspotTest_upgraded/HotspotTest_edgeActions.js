...
var Composition = Edge.Composition, Symbol = Edge.Symbol; // aliases for commonly used Edge classes
   ...
   (function(symbolName) {
      ...
      Symbol.bindElementAction(compId, symbolName, "${HotspotEllipse}", "mousedown", function(sym, e) {
         hotspotUrlToOpen = "http://en.wikipedia.org/wiki/microscope";

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${HotspotEllipse2}", "mousedown", function(sym, e) {
         hotspotUrlToOpen = "http://en.wikipedia.org/wiki/spectrophotometer";

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${HotspotEllipse3}", "mousedown", function(sym, e) {
         hotspotUrlToOpen = "../../Quizzes/MatchupLateral/MatchupLateral.html";

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${HotspotEllipse4}", "mousedown", function(sym, e) {
...
})(window.jQuery || AdobeEdge.$, AdobeEdge, "EDGE-465432216");